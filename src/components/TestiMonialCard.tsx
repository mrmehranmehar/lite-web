...
const testimonials = [
  ...
  {
    quote: 'The platforms comprehensive resources on app development have been crucial for my career growth. The project-based learning approach is highly effective.',
    name: 'Farhan Akram',
    title: 'Mobile App Developer',
  },
  {
